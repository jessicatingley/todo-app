...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signupLoginTextController ??= TextEditingController();
    _model.signupLoginFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/jessicas-tasks-high-resolution-logo.png',
                        width: 120.0,
                        fit: BoxFit.contain,
                      ),
                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.signupLoginTextController,
                                          focusNode:
                                              _model.signupLoginFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.signupLoginTextController',
                                            const Duration(milliseconds: 2000),
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .signupLoginTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      SizedBox(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.signupLoginTextController.text,
