...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for Signup-Login widget.
  FocusNode? signupLoginFocusNode;
  TextEditingController? signupLoginTextController;
  String? Function(BuildContext, String?)? signupLoginTextControllerValidator;
  String? _signupLoginTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  void initState(BuildContext context) {
    ...
    signupLoginTextControllerValidator = _signupLoginTextControllerValidator;
  ...
  void dispose() {
    ...
    signupLoginFocusNode?.dispose();
    signupLoginTextController?.dispose();
